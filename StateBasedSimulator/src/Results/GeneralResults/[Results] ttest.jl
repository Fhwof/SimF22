...
function ttest(r1::Results, r2::Results; equalVar::Bool = false)
    ttest = equalVar ? ttest_student : test_welch
...
ttest_welch(x1, x2, v1, v2, n)        = ttest_calc(x1, x2, var_welch(v1, v2, n), dof_welch(n, v1, v2))
ttest_welch(x1, x2, v1, v2, n1, n2)   = ttest_calc(x1, x2, var_welch(v1, v2, n1, n2), dof_welch(n1, n2, v1, v2))
